...
The end result of this process is a single file, ``calibration_information.json``, which by default will be stored in the same folder as the calibration images. This is the information needed to proceed with 3D analysis. 
